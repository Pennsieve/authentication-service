...
#            'ProviderAttributeName': source_attribute_name,
...
def link_orcid(user_pool_id, provider_id):
    ...
    if user_list is not None:
        ...
        result = admin_link_provider_for_user(user_pool_id, user.cognito_id, "ORCID", "user_id", orcid_id)
    else:
...
def link_external(event):
    ...
    if provider_name == "orcid":
        link_orcid(user_pool_id, provider_id)
    else:
