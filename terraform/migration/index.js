...
async function onUserMigrationAuthentication(cognitoISP, event) {
    ...
    event.response.userAttributes = {
        ...
        'custom:invite_path': user.userAttributes['custom:invite_path'],
        ...(user.userAttributes.hasOwnProperty('custom:orcid')) && {'custom:orcid': user.userAttributes['custom:orcid']},
    };
